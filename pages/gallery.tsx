        ...
        <main className={styles.content}>
            ...
            <div className={styles.category}>
                ...
                <div className={styles.panel}>
                    ...
                    <p lang="bn">আজ সন্ধানীর ৪৬তম প্রতিষ্ঠাবার্ষিকী উপলক্ষে বাংলাদেশ মেডিকেল কলেজ প্রাঙ্গনে কেক কাটা কর্মসূচি সহ র‍্যালির আয়োজন করা হয়।</p>
                </div>
            </div>
            <div className={styles.category}>
                <div className={styles.panel}>
                    <img src="/gallery/gallery_007.webp" alt="অমর একুশে বইমেলা- ২০২৩ সমাপ্তি পর্ব।" width={100} loading="lazy"/>
