...
const HomePage = () => {
    ...
    <div className={styles.main}>
        ...
        <Head>
            ...
            <meta property="og:image" content="https://sbmcu.com/slide/slide_2} />
            ...
            <meta name="twitter:image" content="https://sbmcu.com/slide/slide_2} />
        ...
        <main className={styles.content}>
            ...
            <div className={styles.category}>
                <div className={styles.panel}>
                    <Image width={1080} height={720} src={Image01} alt="সন্ধানী বাংলাদেশ মেডিকেল কলেজ কর্তৃক আয়োজিত 'হাসি ফুটুক প্রতিটি মুখে' এর প্রথম পর্বে 'জামিয়া ইসলামিয়া মুহাম্মাদী আশরাফুল মাদারিস ও এতিমখানা' তে ইফতার মাহফিল এবং এতিমখানার শিশুদের মাঝে কুরআন তিলাওয়াত এবং হামদ-নাত প্রতিযোগিতার আয়োজন করা হয়।" width={100} loading="lazy"/>
                ...
                <div className={styles.panel}>
                    <Image width={1080} height={720} src={Image02} alt="একুশ মানে মাথা নত না করা, একুশ মানে এগিয়ে যাওয়া। একুশের চেতনাকে হৃদয়ে ধারণ করে সন্ধানী বাংলাদেশ মেডিকেল কলেজ ইউনিট 'অমর একুশে বইমেলা -২০২৩' এ  আয়োজন করে 'স্বেচ্ছায় রক্তদান ও রক্তের গ্রুপ নির্ণয় কর্মসূচি'। সকলের স্বতঃস্ফূর্ত অংশগ্রহণে সফল হয় এ আয়োজন।" width={100} loading="lazy"/>
                ...
                <div className={styles.panel}>
                    <Image width={1080} height={720} src={Image03} alt="ঢাকা বিশ্ববিদ্যালয়ের ঐতিহাসিক বটতলা প্রাঙ্গনে আয়োজিত স্বেচ্ছায় রক্তদান কর্মসূচিতে সন্ধানী বাংলাদেশ মেডিকেল কলেজ ইউনিট অংশগ্রহণ করে।" width={100} loading="lazy"/>
            ...
            <div className={styles.category}>
                <div className={styles.panel}>
                    <Image width={1080} height={720} src={Image04} alt="সন্ধানী বাংলাদেশ মেডিকেল কলেজ ইউনিটের প্রতিষ্ঠাবার্ষিকী উপলক্ষে বাংলাদেশ মেডিকেল কলেজ অডিটোরিয়ামে একটি ইফতার ও দোয়া মাহফিলের আয়োজন করা হয়।" width={100} loading="lazy"/>
                ...
                <div className={styles.panel}>
                    <Image width={1080} height={720} src={Image05} alt="পবিত্র বুদ্ধ পূর্ণিমা উপলক্ষে সন্ধানী বাংলাদেশ মেডিকেল কলেজ ইউনিটের সৌজন্যে আন্তর্জাতিক বৌদ্ধ বিহার,মেরুল বাড্ডা - তে ফ্রি মেডিকেল ক্যাম্পের আয়োজন করা হয়। উক্ত ক্যাম্পে স্বেচ্ছায় রক্তদান সহ বিনামূল্যে ব্লাড সুগার নির্ণয়,ব্লাড গ্রুপ নির্ণয় এবং ব্লাড প্রেসার পরিমাপ করা হয়।" width={100} loading="lazy"/>
                ...
                <div className={styles.panel}>
                    <Image width={1080} height={720} src={Image06} alt="আজ সন্ধানীর ৪৬তম প্রতিষ্ঠাবার্ষিকী উপলক্ষে বাংলাদেশ মেডিকেল কলেজ প্রাঙ্গনে কেক কাটা কর্মসূচি সহ র‍্যালির আয়োজন করা হয়।" width={100} loading="lazy"/>
            ...
            <div className={styles.category} >
                ...
                <div className={styles.panel}>
                    <Image width={1080} height={720} src={Image09} alt="সন্ধানী বাংলাদেশ মেডিকেল কলেজ ইউনিটের আয়োজনে ও Incepta Pharmaceutical Limited এর সহযোগিতায় 'Cervical Cancer & It's Prevention' শীর্ষক সেমিনারের আয়োজন করা হয়।" width={100} loading="lazy"/>
            ...
            <div className={styles.category}>
                ...
                <div className={styles.panel}>
                    <Image width={1080} height={720} src={Image11} alt="ঈদ উল ফিতর উপলক্ষে সন্ধানী  বাংলাদেশ মেডিকেল কলেজ ইউনিটের পক্ষ থেকে বাংলাদেশ মেডিকেল কলেজের শ্রদ্ধেয় শিক্ষক মন্ডলী এর সাথে অগ্রীম ঈদ শুভেচ্ছা বিনিময়..." width={100} loading="lazy"/>
                ...
                <div className={styles.panel}>
                    <Image width={1080} height={720} src={Image12} alt="মহান বিজয় দিবস উপলক্ষে Elite Force Bangladesh এর আয়োজনে সন্ধানী বাংলাদেশ মেডিকেল কলেজ ইউনিট এর সহযোগিতায় রক্তদান কর্মসূচি পালিত হয়। উক্ত অনুষ্ঠানে Elite Force এর সদস্যরা স্বতঃস্ফূর্তভাবে অংশগ্রহণ করেন।" width={100} loading="lazy"/>
            ...
            <div className={styles.category}>
                <div className={styles.panel}>
                    <Image width={1080} height={720} src={Image13} alt="সন্ধানী বাংলাদেশ মেডিকেল কলেজ ইউনিট কর্তৃক এক ইফতার মাহফিল আয়োজন করা হয়। উক্ত মাহফিলে উপস্থিত ছিলেন অধ্যাপক ডা: মিজানুর রহমান স্যার।" width={100} loading="lazy"/>
                ...
                <div className={styles.panel}>
                    <Image width={1080} height={720} src={Image14} alt="সন্ধানী বাংলাদেশ মেডিকেল কলেজ ইউনিট কর্তৃক বাংলাদেশ মেডিকেল কলেজের সম্মানিত অধ্যক্ষ,  বাংলাদেশ মেডিকেল কলেজ হাসপাতাল -এর সম্মানিত পরিচালক  এবং সম্মানিত চিকিৎসকবৃন্দের সাথে পবিত্র ঈদ-উল-ফিতর এর শুভেচ্ছা বিনিময় করা হয়।" width={100} loading="lazy"/>
                ...
                <div className={styles.panel}>
                    <Image width={1080} height={720} src={Image15} alt="মহান বিজয় দিবস উপলক্ষে সন্ধানী বাংলাদেশ মেডিকেল কলেজ ইউনিট এর পক্ষ থেকে কলেজ প্রাঙ্গণে বিনামূল্যে রক্তের গ্রুপ, রক্তের গ্লুকোজের পরিমাণ ও রক্তচাপ নির্ণয় এবং স্বেচ্ছায় রক্তদান কর্মসূচির আয়োজন করা হয়।" width={100} loading="lazy"/>
            ...
            <div className={styles.category}>
                <div className={styles.panel}>
                    <Image width={1080} height={720} src={Image16} alt="সন্ধানী, বাংলাদেশ মেডিকেল কলেজ ইউনিটের পক্ষ থেকে কলেজের নবাগত শিক্ষার্থীদের (BM-36) বরণ করে নেয়া হয় এবং 'Training on Blood Grouping & Blood Screening' শীর্ষক ওয়ার্কশপ ও ওয়ার্কশপ পরবর্তী কুইজ প্রতিযোগিতার আয়োজন করা হয়।" width={100} loading="lazy"/>
                ...
                <div className={styles.panel}>
                    <Image width={1080} height={720} src={Image17} alt="সন্ধানী বাংলাদেশ মেডিকেল কলেজ ইউনিট কর্তৃক বাংলাদেশ মেডিকেল কলেজের সম্মানিত অধ্যক্ষ,  বাংলাদেশ মেডিকেল কলেজ হাসপাতাল -এর সম্মানিত পরিচালক  এবং সম্মানিত চিকিৎসকবৃন্দের সাথে পবিত্র ঈদ-উল-ফিতর এর শুভেচ্ছা বিনিময় করা হয়।" width={100} loading="lazy"/>
                    <p lang="bn">সন্ধানী বাংলাদেশ মেডিকেল কলেজ ইউনিট কর্তৃক বাংলাদেশ মেডিকেল কলেজের সম্মানিত অধ্যক্ষ,  বাংলাদেশ মেডিকেল কলেজ হাসপাতাল -এর সম্মানিত পরিচালক  এবং সম্মানিত চিকিৎসকবৃন্দের সাথে পবিত্র ঈদ-উল-ফিতর এর শুভেচ্ছা বিনিময় করা হয়।</p>
                    <br/>
                    <p lang="en">Sandhani Bangladesh Medical College Unit exchanged Eid-ul-Fitr greetings with Honorable Principal of Bangladesh Medical College, Honorable Director of Bangladesh Medical College Hospital and Honorable Doctors.</p>
                </div>
                <div className={styles.panel}>
                    <Image width={1080} height={720} src={Image18} alt="মহান স্বাধীনতা দিবস উপলক্ষে সন্ধানী বাংলাদেশ মেডিকেল কলেজ ইউনিটের পক্ষ থেকে দুস্থ ও অসহায়দের মাঝে ইফতার প্রদান করা হয়।" width={100} loading="lazy"/>
