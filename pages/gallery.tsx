        ...
        <main className={styles.content}>
            ...
            <div className={styles.category}>
                <div className={styles.panel}>
                    <img src="/gallery/gallery_001.webp" alt="Sandhani bangladesh Medical COllege Unit at Work" width={100} loading="lazy"/>
                ...
                <div className={styles.panel}>
                    <img src="/gallery/gallery_002.webp" alt="Sandhani bangladesh Medical COllege Unit at Work" width={100} loading="lazy"/>
                ...
                <div className={styles.panel}>
                    <img src="/gallery/gallery_003.webp" alt="Sandhani bangladesh Medical COllege Unit at Work" width={100} loading="lazy"/>
            ...
            <div className={styles.category}>
                <div className={styles.panel}>
                    <img src="/gallery/gallery_004.webp" alt="Sandhani bangladesh Medical COllege Unit at Work" width={100} loading="lazy"/>
                ...
                <div className={styles.panel}>
                    <img src="/gallery/gallery_005.webp" alt="Sandhani bangladesh Medical COllege Unit at Work" width={100} loading="lazy"/>
                ...
                <div className={styles.panel}>
                    <img src="/gallery/gallery_006.webp" alt="Sandhani bangladesh Medical COllege Unit at Work" width={100} loading="lazy"/>
            ...
            <div className={styles.category}>
                <div className={styles.panel}>
                    <img src="/gallery/gallery_007.webp" alt="Sandhani bangladesh Medical COllege Unit at Work" width={100} loading="lazy"/>
                    <p>অমর একুশে বইমেলা- ২০২৩ সমাপ্তি পর্ব।</p>
                </div>
                <div className={styles.panel}>
                    <img src="/gallery/gallery_008.webp" alt="Sandhani bangladesh Medical COllege Unit at Work" width={100} loading="lazy"/>
                ...
                <div className={styles.panel}>
                    <img src="/gallery/gallery_009.webp" alt="Sandhani bangladesh Medical COllege Unit at Work" width={100} loading="lazy"/>
            ...
            <div className={styles.category}>
                <div className={styles.panel}>
                    <img src="/gallery/gallery_010.webp" alt="Sandhani bangladesh Medical COllege Unit at Work" width={100} loading="lazy"/>
                ...
                <div className={styles.panel}>
                    <img src="/gallery/gallery_011.webp" alt="Sandhani bangladesh Medical COllege Unit at Work" width={100} loading="lazy"/>
                ...
                <div className={styles.panel}>
                    <img src="/gallery/gallery_012.webp" alt="Sandhani bangladesh Medical COllege Unit at Work" width={100} loading="lazy"/>
            ...
            <div className={styles.category}>
                <div className={styles.panel}>
                    <img src="/gallery/gallery_013.webp" alt="Sandhani bangladesh Medical COllege Unit at Work" width={100} loading="lazy"/>
                ...
                <div className={styles.panel}>
                    <img src="/gallery/gallery_014.webp" alt="Sandhani bangladesh Medical COllege Unit at Work" width={100} loading="lazy"/>
                ...
                <div className={styles.panel}>
                    <img src="/gallery/gallery_015.webp" alt="Sandhani bangladesh Medical COllege Unit at Work" width={100} loading="lazy"/>
            ...
            <div className={styles.category}>
                <div className={styles.panel}>
                    <img src="/gallery/gallery_016.webp" alt="Sandhani bangladesh Medical COllege Unit at Work" width={100} loading="lazy"/>
                ...
                <div className={styles.panel}>
                    <img src="/gallery/gallery_017.webp" alt="Sandhani bangladesh Medical COllege Unit at Work" width={100} loading="lazy"/>
                    <p>সন্ধানী বাংলাদেশ মেডিকেল কলেজ ইউনিট কর্তৃক বাংলাদেশ মেডিকেল কলেজের সম্মানিত অধ্যক্ষ,  বাংলাদেশ মেডিকেল কলেজ হাসপাতাল -এর সম্মানিত পরিচালক  এবং সম্মানিত চিকিৎসকবৃন্দের সাথে পবিত্র ঈদ-উল-ফিতর এর শুভেচ্ছা বিনিময় করা হয়।</p>
                </div>
                <div className={styles.panel}>
                    <img src="/gallery/gallery_018.webp" alt="Sandhani bangladesh Medical COllege Unit at Work" width={100} loading="lazy"/>
